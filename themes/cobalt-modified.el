;;; cobalt-modified-theme.el --- cobalt-modified theme

;; Copyright (C) 2012 by Nick Ewing
;; Copyright (C) 2014 by Syohei YOSHIDA
;; Copyright (C) 2017 by Alexander Kyusev
...
(deftheme cobalt-modified
  "cobalt-modified theme")

(custom-theme-set-faces
 'cobalt-modified

 '(default ((t (:background "#0D303A" :foreground "#F8F8F8"))))
 '(cursor ((t (:background "#A7A7A7"))))
 '(border ((t (:foreground "black"))))

 '(buffers-tab ((t (:background "#0D303A" :foreground "white"))))
 '(font-lock-builtin-face ((t (:foreground "#40FFB9"))))
 '(font-lock-comment-face ((t (:foreground "#19B6EE"))))
 '(font-lock-constant-face ((t (:foreground "#FF518C"))))
 '(font-lock-doc-face ((t (:foreground "#46C4F1"))))
 '(font-lock-function-name-face ((t (:foreground "#FFDD00"))))
 '(font-lock-keyword-face ((t (:foreground "#DFB920"))))
 '(font-lock-preprocessor-face ((t (:foreground "#8090A2"))))
 '(font-lock-reference-face ((t (:foreground "#CCCCCC"))))
 '(font-lock-regexp-grouping-backslash ((t (:foreground "#E9C062"))))
 '(font-lock-regexp-grouping-construct ((t (:foreground "red"))))
 '(font-lock-string-face ((t (:foreground "#64C272"))))
